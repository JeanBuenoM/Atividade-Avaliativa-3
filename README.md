...
Desafio 2
Diferente da fila convencional, este código utiliza uma Inserção Ordenada. Em vez de adicionar ao final, a função enqueuePrioridade percorre a lista encadeada para encontrar a posição exata do novo documento baseada no campo prioridade.
